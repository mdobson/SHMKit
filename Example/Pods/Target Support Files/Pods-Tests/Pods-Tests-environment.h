...
// SHMKit
#define COCOAPODS_POD_AVAILABLE_SHMKit
#define COCOAPODS_VERSION_MAJOR_SHMKit 0
#define COCOAPODS_VERSION_MINOR_SHMKit 1
#define COCOAPODS_VERSION_PATCH_SHMKit 0
